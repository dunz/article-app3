...
export const AuthForm: VFC<AuthFormProps> = ({isRegister}) => {
        ...
        <View>
          {isRegister ? (
            <>
              ...
              />
              <TextInput style={styles.input} placeholder="계정명" value={username} onChangeText={setUsername} autoCapitalize="none" />
            </>
          ) : (
            <TextInput
              style={styles.input}
